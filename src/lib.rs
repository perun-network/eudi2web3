...
mod test {
    ...
    use crate::{
        MAX_VALUE_BYTES, MAX_VALUE_SIGNALS, presentation2input, print_execution_time,
        prover::MultiuseProver, sdjwt, witness::CircuitId,
    };
    use serde_json::json;
    ...
    fn compute_proof_using_generated_credential_inner(
        ...
        let presentation =
            sdjwt::new_presentation(claims, sd_strategy, claims_to_disclose, add_decoy_claims)
                .unwrap();
